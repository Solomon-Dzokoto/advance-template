...
export const SlideEditor: React.FC<SlideEditorProps> = ({ slide, onChange }) => {
    ...
    return (
        <div className="w-full p-6 border-2 border-gray-100 rounded-xl bg-white shadow-md hover:shadow-lg transition-all">
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full h-32 p-4 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all resize-none bg-gray-50"
